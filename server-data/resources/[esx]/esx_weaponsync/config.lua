...
Config.Weapons = {
  WEAPON_RAMBKNIFE = { item = 'ramboknife', label = _U('weapon_rambknife') },
  WEAPON_LUCILLE = { item = 'lucille', label = _U('weapon_lucille') },
  WEAPON_KIKETSUSWORD = { item = 'katana', label = _U('weapon_kiketsusword') },
  WEAPON_HORSEBAT = { item = 'horsebat', label = _U('weapon_horsebat') },
  WEAPON_GUITAR = { item = 'guitar', label = _U('weapon_guitar') },
  WEAPON_GIBSON = { item = 'gibson', label = _U('weapon_gibson') },
  WEAPON_BONESAW = { item = 'bonesaw', label = _U('weapon_bonesaw') },
