...
$(document).ready(function(){
                    ...
                    html += `<div class="col-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Kategoria: <b>`+car.categoryLabel+`</b></p>
                                        <p class="card-text">Cena: <b>`+car.price+`$</b></p>
                                    </div>
                                    <div class="card-footer bg-dark border-0 ">
                                        <button type="button" id="action1" data-value="buy" data-model="`+ car.model +`" class="btn btn-danger w-auto btn-lg buy">Kup</button>
                                        <button type="button" id="action2" data-value="test-drive" data-model="`+ car.model +`" class="btn btn-success w-auto float-right btn-lg test-drive">Jazda Próbna - 5000$</button>
                                    </div>
                                </div>
                            </div>`
                    index++;
    ...
    window.addEventListener('message', function(event) {
        ...
        $('#brand').html(`<option selected value="-1">Wszystkie</option>`)
