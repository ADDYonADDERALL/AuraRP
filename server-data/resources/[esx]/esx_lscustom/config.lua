...
Config.Zones = {
	...
	ls4 = {
		Pos   = { x = -110.32, y = -1792.85, z = 26.81},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {5.00, 10.00, 15.00, 20.00}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {2.50, 5.0, 7.5, 10.00}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {7.0, 10.50, 15.0}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {2.0, 3.0, 7.0, 10.00, 12.0}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {5.0, 10.00, 20.00, 30.00, 40.00, 50.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
