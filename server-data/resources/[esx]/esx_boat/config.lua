...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark', price = 180000},
	{model = 'suntrap', label = 'Suntrap', price = 280000},
	{model = 'dinghy', label = 'Dinghy', price = 350000},
	{model = 'jetmax', label = 'Jetmax', price = 400000},
	{model = 'tropic2', label = 'Tropic', price = 450000},
	{model = 'squalo', label = 'Squalo', price = 450000},
	{model = 'speeder', label = 'Speeder', price = 550000},
	{model = 'toro', label = 'Toro', price = 1000000}
}