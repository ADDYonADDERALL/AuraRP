...
--- Config ---
notWhitelistedMessage = "Nie masz whitelisty; DISCORD: http://www.discord.gg/Qs7rpr7" -- Message displayed when they are not whitelist with the role
...
AddEventHandler("playerConnecting", function(name, setCallback, deferrals)
    ...
    deferrals.defer()
    deferrals.update("Sprawdzanie Whitelist...")
    ...
    if identifierDiscord then
        ...
        deferrals.done("Nie wykryto discorda")
    end
end)