...
RegisterNetEvent('animacjawyrzuc')
AddEventHandler('animacjawyrzuc', function()
  ...
  if not IsPedInAnyVehicle(pid, false) then
	TaskPlayAnim(pid, "random@mugging1", "pickup_low", 1.0, -1.0, -1, 48, 0, 0, 0, 0)
  end
end)
...
AddEventHandler('esx:removeInventoryItem', function(item, count, silent, silent2)
...
RegisterNetEvent('esx:sandyammokurwa')
AddEventHandler('esx:sandyammokurwa', function(item, quantity)
	local playerPed  = GetPlayerPed(-1)
	AddAmmoToPed(playerPed, item, quantity)
end)
