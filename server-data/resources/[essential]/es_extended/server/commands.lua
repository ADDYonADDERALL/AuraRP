...
TriggerEvent('es:addGroupCommand', 'tp', 'adminx', function(source, args, user)
	local x = tonumber(args[1])
	local y = tonumber(args[2])
	local z = tonumber(args[3])
...
TriggerEvent('es:addGroupCommand', 'setjob', 'adminx', function(source, args, user)
	if tonumber(args[1]) and args[2] and tonumber(args[3]) then
		local xPlayer = ESX.GetPlayerFromId(args[1])
	...
	if tonumber(args[1]) and args[2] and tonumber(args[3]) then
		...
		if xPlayer then
			if ESX.DoesJobExist(args[2], args[3]) then
				...
				TriggerEvent("atlantisNSA:commandESX", GetPlayerName(source), "setjob2")
			else
				TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'That job does not exist.' } })
			end
		else
...
TriggerEvent('es:addGroupCommand', 'setjob2', 'adminx', function(source, args, user)
	if tonumber(args[1]) and args[2] and tonumber(args[3]) then
		local xPlayer = ESX.GetPlayerFromId(args[1])
...
TriggerEvent('es:addGroupCommand', 'car', 'adminx', function(source, args, user)
	TriggerClientEvent('esx:spawnVehicle', source, args[1])
	TriggerEvent("atlantisNSA:commandESX", GetPlayerName(source), "car")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'dv', 'adminx', function(source, args, user)
	TriggerClientEvent('esx:deleteVehicle', source)
	TriggerEvent("atlantisNSA:commandESX", GetPlayerName(source), "dv")
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
...
TriggerEvent('es:addGroupCommand', 'setmoney', 'adminx', function(source, args, user)
	local _source = source
	local target = tonumber(args[1])
	local money_type = args[2]
	local money_amount = tonumber(args[3])
...
TriggerEvent('es:addGroupCommand', 'giveaccountmoney', 'adminx', function(source, args, user)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(args[1])
	local account = args[2]
	local amount  = tonumber(args[3])
...
TriggerEvent('es:addGroupCommand', 'giveitem', 'adminx', function(source, args, user)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(args[1])
	local item    = args[2]
	local count   = (args[3] == nil and 1 or tonumber(args[3]))
...
TriggerEvent('es:addGroupCommand', 'clearinventory', 'adminx', function(source, args, user)
	local xPlayer
...
TriggerEvent('es:addGroupCommand', 'clearloadout', 'adminx', function(source, args, user)
	local xPlayer
