local Components = {
	{label = _U('sex'),						name = 'sex',				value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('face'),					name = 'face',				value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('face_2'),					name = 'face_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('blend_face'),				name = 'blend_face',		value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('skin'),					name = 'skin',				value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('skin_2'),					name = 'skin_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('blend_skin'),				name = 'blend_skin',		value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('face_3'),					name = 'face_3',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('skin_3'),					name = 'skin_3',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('blend'),					name = 'blend',				value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('hair_1'),					name = 'hair_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('hair_2'),					name = 'hair_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('hair_3'),					name = 'hair_3',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('hair_color_1'),			name = 'hair_color_1',		value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('hair_color_2'),			name = 'hair_color_2',		value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('tshirt_1'),				name = 'tshirt_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('tshirt_2'),				name = 'tshirt_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'tshirt_1'},
	{label = _U('torso_1'),					name = 'torso_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('torso_2'),					name = 'torso_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'torso_1'},
	{label = _U('decals_1'),				name = 'decals_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('decals_2'),				name = 'decals_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'decals_1'},
	{label = _U('arms'),					name = 'arms',				value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('arms_2'),					name = 'arms_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'arms'},
	{label = _U('pants_1'),					name = 'pants_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('pants_2'),					name = 'pants_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'pants_1'},
	{label = _U('shoes_1'),					name = 'shoes_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = -0.8},
	{label = _U('shoes_2'),					name = 'shoes_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = -0.8,	textureof	= 'shoes_1'},
	{label = _U('mask_1'),					name = 'mask_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('mask_2'),					name = 'mask_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'mask_1'},
	{label = _U('bproof_1'),				name = 'bproof_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('bproof_2'),				name = 'bproof_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'bproof_1'},
	{label = _U('chain_1'),					name = 'chain_1',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.0},
	{label = _U('chain_2'),					name = 'chain_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'chain_1'},
	{label = _U('helmet_1'),				name = 'helmet_1',			value = -1,		min = -1,	zoomOffset = 1.5,		camOffset = 0.0,	componentId	= 0},
	{label = _U('helmet_2'),				name = 'helmet_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'helmet_1'},
	{label = _U('glasses_1'),				name = 'glasses_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('glasses_2'),				name = 'glasses_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'glasses_1'},
	{label = _U('watches_1'),				name = 'watches_1',			value = -1,		min = -1,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('watches_2'),				name = 'watches_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'watches_1'},
	{label = _U('bracelets_1'),				name = 'bracelets_1',		value = -1,		min = -1,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('bracelets_2'),				name = 'bracelets_2',		value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'bracelets_1'},
	{label = _U('bag'),						name = 'bags_1',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0},
	{label = _U('bag_color'),				name = 'bags_2',			value = 0,		min = 0,	zoomOffset = 1.5,		camOffset = 0.0,	textureof	= 'bags_1'},
...
function LoadDefaultModel(malePed, cb)
	...
	if DecorExistOn(ped, "aura:model") then
		characterModel = DecorGetInt(ped, "aura:model")
	elseif malePed then
