...
------
-- RegisterNetEvent SANDY_InteractSound_CL:PlayOnOne
--
...
------
RegisterNetEvent('SANDY_InteractSound_CL:PlayOnOne')
AddEventHandler('SANDY_InteractSound_CL:PlayOnOne', function(soundFile, soundVolume)
    SendNUIMessage({
...
------
-- RegisterNetEvent SANDY_InteractSound_CL:PlayOnAll
--
-- @param soundFile    - The name of the soundfile within the client/html/sounds/ folder.
--                     - Can also specify a folder/sound file.
-- @param soundVolume  - The volume at which the soundFile should be played. Nil or don't
...
------
RegisterNetEvent('SANDY_InteractSound_CL:PlayOnAll')
AddEventHandler('SANDY_InteractSound_CL:PlayOnAll', function(soundFile, soundVolume)
    SendNUIMessage({
        transactionType     = 'playSound',
        transactionFile     = soundFile,
        transactionVolume   = soundVolume
...
------
-- RegisterNetEvent SANDY_InteractSound_CL:PlayWithinDistance
--
...
------
RegisterNetEvent('SANDY_InteractSound_CL:PlayWithinDistance')
AddEventHandler('SANDY_InteractSound_CL:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
