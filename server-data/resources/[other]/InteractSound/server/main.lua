...
------
-- RegisterServerEvent SANDY_InteractSound_SV:PlayOnOne
-- Triggers -> ClientEvent SANDY_InteractSound_CL:PlayOnOne
--
...
------
RegisterServerEvent('SANDY_InteractSound_SV:PlayOnOne')
AddEventHandler('SANDY_InteractSound_SV:PlayOnOne', function(clientNetId, soundFile, soundVolume)
    TriggerClientEvent('SANDY_InteractSound_CL:PlayOnOne', clientNetId, soundFile, soundVolume)
end)

------
-- RegisterServerEvent SANDY_InteractSound_SV:PlayOnSource
-- Triggers -> ClientEvent SANDY_InteractSound_CL:PlayOnSource
--
-- @param soundFile    - The name of the soundfile within the client/html/sounds/ folder.
--                     - Can also specify a folder/sound file.
-- @param soundVolume  - The volume at which the soundFile should be played. Nil or don't
...
------
RegisterServerEvent('SANDY_InteractSound_SV:PlayOnSource')
AddEventHandler('SANDY_InteractSound_SV:PlayOnSource', function(soundFile, soundVolume)
    TriggerClientEvent('SANDY_InteractSound_CL:PlayOnOne', source, soundFile, soundVolume)
end)

------
-- RegisterServerEvent SANDY_InteractSound_SV:PlayOnAll
-- Triggers -> ClientEvent SANDY_InteractSound_CL:PlayOnAll
--
-- @param soundFile     - The name of the soundfile within the client/html/sounds/ folder.
--                      - Can also specify a folder/sound file.
-- @param soundVolume   - The volume at which the soundFile should be played. Nil or don't
...
------
RegisterServerEvent('SANDY_InteractSound_SV:PlayOnAll')
AddEventHandler('SANDY_InteractSound_SV:PlayOnAll', function(soundFile, soundVolume)
    TriggerClientEvent('SANDY_InteractSound_CL:PlayOnAll', -1, soundFile, soundVolume)
end)

------
-- RegisterServerEvent SANDY_InteractSound_SV:PlayWithinDistance
-- Triggers -> ClientEvent SANDY_InteractSound_CL:PlayWithinDistance
--
...
------
RegisterServerEvent('SANDY_InteractSound_SV:PlayWithinDistance')
AddEventHandler('SANDY_InteractSound_SV:PlayWithinDistance', function(maxDistance, soundFile, soundVolume)
    TriggerClientEvent('SANDY_InteractSound_CL:PlayWithinDistance', -1, source, maxDistance, soundFile, soundVolume)
end)
